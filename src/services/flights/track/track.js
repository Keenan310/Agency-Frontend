...
window.KeenanFrontend.modules["page-track"] = {
  ...
  mount(root) {
        ...
        resultBox.innerHTML = `
          <div class="card" style="padding:28px">
            ...
            <div style="display:flex;flex-direction:column;gap:0">
              ...
              <div style="display:flex;justify-content:space-between;font-size:13.5px;padding:11px 0;border-bottom:1px solid var(--surface3)">
                <span style="color:var(--slate)">AG / NDC Reference</span>
                <span style="font-weight:600">
                  ${booking.agNumber || "-"}
                </span>
              </div>
              ...
              <button
                class="btn-gold w100"
                style="margin-top:22px;padding:13px;font-size:15px"
                onclick="downloadTrackPdf()"
              >
                Download PDF
              </button>
    ...
    window.downloadTrackPdf = function () {
      const resultBox = document.getElementById("track-result");

      if (!resultBox || resultBox.style.display === "none") {
        alert("Please track a booking first");
        return;
      }
      ...
      printWindow.document.write(`
        <html>
          <head>
            <title>Keenan Travel Booking</title>
            <style>
              body {
          ...
          <body>
            <div class="brand">Keenan Travel</div>
            <h1>Booking Tracking Details</h1>
            ${resultBox.innerHTML}
          </body>
        </html>
      `);
